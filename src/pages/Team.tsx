...
export const Team = () => {
  const team = [
    ...
    },
    {
      ...
      qualifications: 'CFA Level I Cleared, BCom (Accounts & Finance)',
      workProfile: 'Equity Research & Financial Analysis',
      location: 'Mumbai, Maharashtra, India',
      email: 'palak.joshi@gmail.com',
      linkedin: 'https://www.linkedin.com/in/palak-joshi-56531b30b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
      description: 'Equity Research Analyst at SHARECOMPLEX LLP since November 2025. Experienced in equity research, financial analysis, and investment recommendations.',
      image: '/WhatsApp Image 2026-01-23 at 2.04.11 PM.jpeg'
    }
  ];
    ...
    <div className="py-24 pt-32">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-brand-blue mb-4">Our Team</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {team.map((member, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all group">
              ...
              <div className="p-6">
                ...
                <p className="text-brand-green font-semibold mb-3">{member.title}</p>
                <p className="text-sm text-gray-700 mb-2 bg-brand-light-blue p-3 rounded">{member.qualifications}</p>
                <p className="text-sm text-gray-600 mb-4 italic">{member.workProfile}</p>
                ...
                <div className="flex items-center mb-2 text-sm">
                  ...
                  <a href={`mailto:${member.email}`} className="text-gray-700 hover:text-brand-blue truncate">{member.email}</a>
                </div>
                ...
                <p className="text-gray-700 mt-4 border-t pt-4">{member.description}</p>
              </div>
            </div>
          ))}
        </div>
